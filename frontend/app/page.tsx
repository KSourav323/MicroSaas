...
import { Hammer, Wrench, Settings, Compass, Paintbrush, Ruler, Cog, Scissors } from 'lucide-react'; 
...
<div className="mb-6 md:mb-8 inline-block">
  <div 
    className={`w-16 h-16 md:w-20 md:h-20 mx-auto ${borderClass} border rounded-full flex items-center justify-center backdrop-blur-xl ${bgCardClass} animate-scaleIn relative overflow-hidden`}
    style={{ animation: 'premiumGlow 3s ease-in-out infinite' }}
  >
    <Hammer className={`w-8 h-8 md:w-10 md:h-10 ${isDark ? 'text-white/40' : 'text-black/40'} absolute opacity-0 transition-all duration-500`} 
      strokeWidth={1}
      style={{ 
        animation: 'premiumFade 8s ease-in-out infinite',
        animationDelay: '0s'
      }} 
    />
    <Wrench className={`w-8 h-8 md:w-10 md:h-10 ${isDark ? 'text-white/40' : 'text-black/40'} absolute opacity-0 transition-all duration-500`} 
      strokeWidth={1}
      style={{ 
        animation: 'premiumFade 8s ease-in-out infinite',
        animationDelay: '1s'
    ...
    />
    <Settings className={`w-8 h-8 md:w-10 md:h-10 ${isDark ? 'text-white/40' : 'text-black/40'} absolute opacity-0 transition-all duration-500`} 
      strokeWidth={1}
      style={{ 
        animation: 'premiumFade 8s ease-in-out infinite',
        animationDelay: '2s'
    ...
    />
    <Compass className={`w-8 h-8 md:w-10 md:h-10 ${isDark ? 'text-white/40' : 'text-black/40'} absolute opacity-0 transition-all duration-500`} 
      strokeWidth={1}
      style={{ 
        animation: 'premiumFade 8s ease-in-out infinite',
        animationDelay: '3s'
    ...
    />
    <Paintbrush className={`w-8 h-8 md:w-10 md:h-10 ${isDark ? 'text-white/40' : 'text-black/40'} absolute opacity-0 transition-all duration-500`} 
      strokeWidth={1}
      style={{ 
        animation: 'premiumFade 8s ease-in-out infinite', 
        animationDelay: '4s'
    ...
    />
    <Ruler className={`w-8 h-8 md:w-10 md:h-10 ${isDark ? 'text-white/40' : 'text-black/40'} absolute opacity-0 transition-all duration-500`} 
      strokeWidth={1}
      style={{ 
        animation: 'premiumFade 8s ease-in-out infinite',
        animationDelay: '5s'
    ...
    />
    <Cog className={`w-8 h-8 md:w-10 md:h-10 ${isDark ? 'text-white/40' : 'text-black/40'} absolute opacity-0 transition-all duration-500`} 
      strokeWidth={1}
      style={{ 
        animation: 'premiumFade 8s ease-in-out infinite',
        animationDelay: '6s'
    ...
    />
    <Scissors className={`w-8 h-8 md:w-10 md:h-10 ${isDark ? 'text-white/40' : 'text-black/40'} absolute opacity-0 transition-all duration-500`} 
      strokeWidth={1}
      style={{ 
        animation: 'premiumFade 8s ease-in-out infinite',
        animationDelay: '7s'
